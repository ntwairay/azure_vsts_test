...
$subscriptionName =     "ntwairay"          # name of the Azure subscription
$cloudwiseAppServiceURL="https://newrelic.com"          # this is the Unique URL of the Cloudwise App Service deployed by the ARM script
# --END MANDATORY PARAMETERS

$suffix =               "ntwairay"     #-- Name of the company/deployment. This is used to create a unique website name in your organization
$tenantID=              "88a4986e-ab2a-4006-98b6-c899a41158ab"
